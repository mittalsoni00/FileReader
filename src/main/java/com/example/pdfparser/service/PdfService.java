...
import com.example.pdfparser.service.OpenAiService; // ✅ your custom class
...
public class PdfService {
    ...
    /**
     * Use OpenAI API to extract specific details from the PDF text.
     */
    public Map<String, String> extractDetailsFromText(String pdfText) {
        ...
        String extractedText = openAiService.askChatGPT(prompt);
...
//    private final OpenAiService openAiService;
//
//    // ✅ Inject OpenAiService via constructor
//    public PdfService(OpenAiService openAiService) {
//        this.openAiService = openAiService;
//    }
//
...
//        String extractedText = choices.isEmpty() ? "No response" : choices.get(0).getText().trim();
//
//        Map<String, String> extractedData = new HashMap<>();
//        extractedData.put("response", extractedText);
//        return extractedData;
